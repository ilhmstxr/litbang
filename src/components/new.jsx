  {/* JOURNEY SECTION */}
      <section id="journey" className="px-6 py-20 bg-neutral-950 relative">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20">
             ...
             <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-white -mt-10 md:-mt-16 ml-10 md:ml-20 relative z-10">OF <span className="text-lime-400 underline decoration-4 decoration-white underline-offset-8">ACTION</span></h2>
          </div>
            ...
            <div className="md:col-span-8 relative group cursor-pointer">
              <RevealCard className="h-full">
                <div className="h-[500px] rounded-3xl relative overflow-hidden border border-neutral-800 group-hover:border-lime-400 transition-all duration-500">
                   ...
                   <div className="absolute top-28 right-8 opacity-20 group-hover:opacity-100 transition-opacity"><Zap className="text-lime-400" size={64} /></div>
                </div>
              </RevealCard>
            </div>
      ...
      <section id="social" className="py-24 bg-white text-black relative">
        <div className="max-w-7xl mx-auto px-6">
          <RevealCard>
             <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter mb-12 text-center">On <span className="text-lime-500 italic">Socials</span></h2>
          </RevealCard>

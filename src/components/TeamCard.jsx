...
const TeamCard = ({ role, title, traits, quote, img, instagram }) => {
  return (
    <div className="group relative w-full h-[450px] bg-neutral-800 rounded-3xl overflow-hidden border border-neutral-700 hover:border-primary transition-all duration-500 hover:-translate-y-2">
      {/* Image Layer */}

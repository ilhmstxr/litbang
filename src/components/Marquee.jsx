...
const Marquee = ({ text, direction = 'left' }) => {
  return (
    <div className="overflow-hidden w-full">
      <div className="relative flex overflow-x-hidden bg-lime-400 py-4 text-black font-black uppercase tracking-tighter transform -skew-y-2 border-y-4 border-black z-20 w-[110%] -ml-[5%]">

...
import { ArrowRight, Instagram, Zap, Globe, MousePointer2, ChevronDown, Camera, Upload, Plus } from 'lucide-react';
       ...
       {cards.map((card, idx) => {
         ...
         return (
           <div 
             ...
             style={{ 
               // Dynamic spacing on hover calculated roughly via css class logic or inline style
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans selection:bg-lime-400 selection:text-black overflow-x-hidden cursor-none">
      ...
      <nav className="fixed w-full z-40 px-6 py-6 flex justify-between items-center mix-blend-difference">
        ...
        <div className="hidden md:flex gap-8 font-bold text-sm uppercase tracking-widest">
          {['Journey', 'Social', 'Memories'].map((item) => (
      ...
      {/* JOURNEY SECTION - More Images in Cards */}
      <section id="journey" className="px-6 py-20 bg-neutral-950 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            {/* Card 1: Workshop - Image Background */}
            ...
            {/* Card 3: Belajar - Horizontal Full */}
      ...
      {/* SOCIAL SECTION - Phone Mockup Style */}
      ...
      {/* MEMORIES - FAN / DECK STYLE (REFERENSI LANDO NORRIS) */}
